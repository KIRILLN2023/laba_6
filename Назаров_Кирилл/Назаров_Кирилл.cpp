...
int main() {
    ...
    cout << "Назаров Кирилл лаба 6!" << endl;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(shader.ID, "light.position"), 2.0f, 5.0f, 2.0f);
        ...
        //материал
        glUniform3f(glGetUniformLocation(shader.ID, "material.ambient"), 0.8f, 0.1f, 0.1f);  
        glUniform3f(glGetUniformLocation(shader.ID, "material.diffuse"), 0.2f, 0.6f, 0.9f);  
